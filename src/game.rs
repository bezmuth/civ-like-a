...
impl<'a, 'b> SimpleState for Civ<'a, 'b> {
    fn on_start(&mut self, data: StateData<'_, GameData<'_, '_>>) {
        ...
        dispatcher_builder.add(systems::PaddleSystem, "paddle_system", &[]);
        dispatcher_builder.add(systems::MoveBallsSystem, "ball_system", &["paddle_system"]);
        dispatcher_builder.add(systems::BounceSystem, "collision_system", &["paddle_system", "ball_system"],);
